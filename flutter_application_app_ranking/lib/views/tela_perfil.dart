...
class _TelaPerfilState extends State<TelaPerfil> {
  ...
  Future<void> _alterarFotoPerfil() async {
    ...
    try {
      ...
      await supabase.storage
          .from('avatars')
          .uploadBinary(nomeArquivo, byteData);
      ...
      _mostrarMensagem("Foto de perfil atualizada!", AppColors.success);
    } catch (e) {
      setState(() => _salvando = false);
      _mostrarMensagem("Erro ao enviar foto: $e", AppColors.error);
    }
  }
  ...
  InputDecoration _inputDecoration(String label, IconData iconData) {
    return buildInputDecoration(label: label, icon: iconData).copyWith(
